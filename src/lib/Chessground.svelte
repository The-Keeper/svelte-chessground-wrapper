...
<style>
    ...
    .cg-default-style.cg-wrap.orientation-white
        :global(coords.ranks coord:nth-child(2n)),
    .cg-default-style.cg-wrap.orientation-white
        :global(coords.files coord:nth-child(2n)),
    .cg-default-style.cg-wrap.orientation-black
        :global(coords.ranks coord:nth-child(2n + 1)),
    .cg-default-style.cg-wrap.orientation-black
        :global(coords.files coord:nth-child(2n + 1)) {
